...
public:
    ...
    void set_per_unit_transportation_cost_variance(unsigned int t_i, unsigned int t_j, double t_value) { m_per_unit_transportation_cost_deviations[t_i][t_j] = t_value; }
};
