...
class Instance {
    ...
    // Connections
    std::vector<std::vector<double>> m_transportation_fixed_costs;
    std::vector<std::vector<double>> m_per_unit_transportation_costs;
    std::vector<std::vector<double>> m_per_unit_transportation_cost_variances;
...
public:
    ...
    [[nodiscard]] double transportation_fixed_cost(unsigned int t_i, unsigned int t_j) const { return m_transportation_fixed_costs[t_i][t_j]; }
    ...
    [[nodiscard]] double per_unit_transportation_cost_variance(unsigned int t_i, unsigned int t_j) const { return m_per_unit_transportation_cost_variances[t_i][t_j]; }
    ...
    void set_transportation_fixed_cost(unsigned int t_i, unsigned int t_j, double t_value) { m_transportation_fixed_costs[t_i][t_j] = t_value; }
    ...
    void set_per_unit_transportation_cost_variance(unsigned int t_i, unsigned int t_j, double t_value) { m_per_unit_transportation_cost_variances[t_i][t_j] = t_value; }
};
